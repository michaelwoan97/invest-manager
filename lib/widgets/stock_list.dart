...
class StockList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider.value(
      ...
      child: ResponsiveLayout(mobileBody: _stockListMobile(context), tabletVersion: _stockListTablet(context), desktopVersion: _stockListTablet(context),),
    );
  }
                                      ...
                                      child: Consumer<Sneaker>(
                                        builder: (ctx, sneaker, _) =>
                                          ...
                                          title: Text(arrSneakers[index]
                                              .getSneakerName, style: TextStyle(fontSize: kMobileBodyText),),
                                          subtitle: Text('QTY: ' +
                                              arrSneakers[index]
                                                  .getAvailableStocks
                                                  .length
  ...
  Widget _stockListTablet(BuildContext context) {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text("Inventory", style: AppTheme.displayInvenTitle(context, kDesktopSubHeadings)),
          if (arrSneakers.isNotEmpty) ...[
            Consumer<SneakerManager>(
              builder: (ctx, sneakerManager, _) => Container(
                height: 400,
                                  ...
                                  child: Consumer<Sneaker>(
                                    builder: (ctx, sneaker, _) =>
                                        ListTile(
                                          ...
                                          title: Text(arrSneakers[index]
                                              .getSneakerName, style: TextStyle(fontSize: kDesktopBodyText),),
                                          subtitle: Text('QTY: ' +
                                              arrSneakers[index]
                                                  .getAvailableStocks
                                                  .length
